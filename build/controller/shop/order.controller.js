...
exports.createOrderWithCard = exports.getAdminReviews = exports.getAdminOrder = exports.payOrderWithWallet = exports.getUserOrder = exports.getAllOrder = exports.getOrder = exports.registeredUserCreateOrder = exports.visitorCreateOrder = void 0;
...
exports.createOrderWithCard = (0, express_async_handler_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { email, total, orderitem, name, state, city, address, country, status, shipping, phone, shippingType, refNo, } = req.body;
    const { authId } = req;
    const currentDate = new Date();
    try {
        yield prisma_client_1.default.order.create({
            data: Object.assign(Object.assign({ email,
                ...
                city,
                address,
                status, placedOn: `${new Date().toDateString()}`, country,
                shipping,
                phone,
                shippingType }, (authId ? { user: { connect: { id: authId } } } : {})), { refNo, arrivalDate: currentDate + "" }),
        });
        res.status(http_status_codes_1.StatusCodes.OK).json({
            message: "Order placed successfully",
        });
